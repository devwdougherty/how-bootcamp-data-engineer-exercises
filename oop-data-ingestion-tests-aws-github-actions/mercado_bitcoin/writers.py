...
class DataWriter:
    ...
    def _write_row(self, row: str) -> None:
        ...
        with open(
            self.filename, "a"
        ) as f:  # 'a' append mode: add new data instead override the file 'w' -> write
            f.write(row)
...
class S3Writter(DataWriter):
    ...
    def _write_file_to_s3(self):
        self.client.put_object(
            Body=self.tempfile, Bucket="mercado-bitcoin-exercise-29-11", Key=self.key
        )
